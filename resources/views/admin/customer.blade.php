            ...
            <div class="modal-content">
                ...
                <form action="" id="admin_form" method="post">
                    <div class="modal-body">
                        ...
                        <input type="text" id="role" name="role" value="4" style="display: none" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" class="form-control is-invalid" id="phone" placeholder="Phone number">
                        </div>
                        <div class="form-group">
                            <label for="address">Address</label>
                            <input type="text" name="address" class="form-control is-invalid" id="address" placeholder="Address">
                        </div>
                       {{--  <div class="form-group">
...
<script src="https://cdn.jsdelivr.net/sweetalert2/5.3.5/sweetalert2.min.js"></script>
    <script>
        ...
        function fetch_data(page) {
            $.ajax({
                url: "/admin/user/customerFetchbyPage?page=" + page,
