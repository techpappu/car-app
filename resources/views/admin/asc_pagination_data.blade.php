...
<ul class="car-sortedby">
    <li class="{{ Request::is('admin/user/seller/car/all/*') ? 'active' : '' }}"><a href="{{route('admin.seller.car',$user->id)}}">All ({{$allDataCount}})</a>|</li>
    <li class="{{ Request::is('admin/user/seller/car/available*') ? 'active' : '' }}"><a href="{{route('admin.seller.car.available',$user->id)}}">Available ({{$available->total()}})</a>|</li>
    <li class="{{ Request::is('admin/user/seller/car/sold*') ? 'active' : '' }}"><a href="{{route('admin.seller.car.sold',$user->id)}}">Sold ({{$sold->total()}})</a>|</li>
    <li class="{{ Request::is('admin/user/seller/car/reserved*') ? 'active' : '' }}"><a href="{{route('admin.seller.car.reserved',$user->id)}}">Reserved ({{$reserved->total()}})</a></li>
</ul>
