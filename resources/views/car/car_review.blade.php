    ...
    <div class="container">
        ...
        <div class="row" style="margin: 0 auto; max-width:832px">
            ...
            <div class="col-sm-12" style="background: #F4F4F4;">
                <div class="alert alert-danger alert-dismissible" id="alertdanger" role="alert" style="margin-top: 5px;display: none"></div>
                <div class="alert alert-success" id="alertsuccess" style="margin-top: 5px;display: none"></div>
        ...
        <script>
            ...
            $('#reviewForm').on('submit', function(event) {
                    ...
                    var url = "{{ route('admin.review-post') }}";
