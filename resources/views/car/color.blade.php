...
@section('content')
    ...
    <div class="modal-header">
        <button type="button" id="car_add" class="btn btn-primary mr-auto" style="float: right" data-toggle="modal"
            data-target="#colorModal">Add New
        </button>
    </div>
    <div class="clearfix"></div>
    <!-- Modal -->
    <div class="modal fade" id="colorModal" tabindex="-1" role="dialog" aria-labelledby="colorModal"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class='col-12 modal-title text-center'>Add Color</h5>
                ...
                <form action="" id="color_form" method="post">
                    <div class="modal-body">
                        @csrf
                        <input type="text" id="id" name="id" style="display: none" />
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="text" name="name" class="form-control is-invalid" id="colorName"
                                placeholder="Car color name" required>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div id="table_data">
                        @include('car.color_pagination_data')
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#colorName').val(response.data.name);
                    $('.modal-title').text("Edit Color Name");
